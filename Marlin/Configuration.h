...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2844.44,417}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {100, 100, 4, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1000,1000,100,800}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.

#define DEFAULT_ACCELERATION          800    // X, Y, Z and E acceleration in mm/s^2 for printing moves
#define DEFAULT_RETRACT_ACCELERATION  800    // E acceleration in mm/s^2 for retracts
...
// Preheat Constants
  ...
  #define PREHEAT_1_FAN_SPEED 0    // Insert Value between 0 and 255
